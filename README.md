...
It uses an AMOLED display with LVGL to provide a graphical gauge for indicated airspeed (IAS) and flaps position, receiving real-time data via the CAN bus (TWAI).
