...
static lv_display_t *bsp_display_lcd_init(const bsp_display_cfg_t *cfg)
{
    ...
    const uint16_t buffer_height = 50;
    const bool use_psram = true;
    const bool require_double_buffer = true;
#else
    const uint16_t buffer_height = 10;
    const bool use_psram = false;
    const bool require_double_buffer = false;
#endif
    ...
    esp_lv_adapter_display_config_t disp_cfg = {
        ...
        .profile = {
            ...
            .require_double_buffer = require_double_buffer,
        },
